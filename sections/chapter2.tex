...
= 1$, that is no entrainement~\cite{Link1999}, and 
...
maximum amplitute that can be sustained by the crust reservoir, which means 
...
Fig.~\ref{fig:ifrac_vs_m} shows the average value of the fraction of crust 
...
% section 1
% =========
In this chapter, we have first explained how to theoretically determine the NS
observables for a given EoS.
