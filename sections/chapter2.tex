...
% obs
% -> mass in binaries with the Shapiro delay technique
% -> radius with Nicer, tidal, etc.

% hydrostatic equilibrium in GR
From the theoretical point of view, the NS masses and radii correspond to the 
solution of the hydrostatic equilibrium equations, which are, in general 
relativity (GR) for spherical and nonrotating 
...
\end{center}
\caption[Crust thickness and mass for several popular EoS]{Crust thickness
  $l_{crust}$ (upper panel) and mass $M_{crust}$ (lower panel) as a function of 
