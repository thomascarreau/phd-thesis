...
% 1.explain tidal deformability (dimless, lambda1-lambda2, lambda tilde...)
% 2.derive equations from k2 love number
% 3.observable of interest since gw170817 event
% 4.figure
% 5.discussion (notice the tug of war: ifrac,mass wants stiff eos but lambda 
%   want soft)
...
\begin{figure}[!t]
  ...
  \end{center}
  \caption[Dimensionless tidal deformability versus NS mass for several popular
  EoS]{Dimensionless tidal deformability $\Lambda$ as a function of the NS mass 
    $M$ for several popular EoS calculated within the metamodeling 
  technique. The black dotted line marks the NS canonical mass, that is
$1.4M_\odot$. The upper bound $\Lambda_{1.4} \leq 800$ inferred from GW170817 
event is also represented~\cite{GWtidal}.}\label{fig:tidal_popular}
\end{figure}
