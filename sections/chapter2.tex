...
% *what is tidal deformability (definition and equations, analogy moon-earth)
% general definition tidal deformability (also say it depends on the eos)
% example earth-moon
% example bns merger (this quantity can be measured using gw observations, 
%   ultimately leading to new constraints on the eos. blabla gw170817)
...
%
\begin{equation}
  \Lambda = \frac{\lambda}{M^5} = \frac{2}{3}k^2\beta^{-5},
\end{equation}
%
where we have introduced the compactness of the star $\beta = GM/(Rc^2)$.
% explanation what is k2? 
% blabla asymtotic expansion of the metric at large r
% blabla einstein field equations
Similarly to the calculation of the moment of inertia in the slow rotation
approximation, $k_2$ can be obtained from the solution of the following 
...
$1.4M_\odot$. In the lower panel, the upper bound $\Lambda_{1.4} \leq 800$ 
inferred from GW170817 event is 
represented~\cite{GWtidal}.}\label{fig:tidal_popular}
\end{figure}

% discussion figure (Let us notice the tug of war: ifrac,mass wants stiff eos 
%   but lambda wants soft)
...
% different estimations of crustal entrainment
