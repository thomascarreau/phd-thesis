...
\subsection{Moment of inertia within the slow rotation approximation} % 2
...
\begin{equation}
  ...
  \frac{P}{c^2}\right)\frac{\bar{\omega}}{\Omega}e^{-\lambda-\Phi},
\end{equation}
%
...
%
\begin{equation}
  \frac{d}{dr}\left(r^4j\frac{d\tilde{\omega}}{dr}\right) =
  -4r^3\tilde{\omega}\frac{dj}{dr},
\end{equation}
%
with $\tilde{\omega} = \bar{\omega}/\Omega$ the unitless frequency.

% same strategy as before (mass-radius) for determining the crust moment of
%   inertia
...
\end{center}
\caption[Normalized moment of inertia and fraction of crust moment of inertia
versus NS mass for several popular EoS]{Normalized moment of
