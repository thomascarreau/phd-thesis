...
% plan
% most of the results presented in this Chapter are published or submitted
...
NSE is sufficient. 
We have seen that a rearragement term enters the expression of thermodynamic 
...
point, and exhibits a discontinous behavior due to the shell effects. 
...
and alter the existing one, and so the relativistic electon gas.

Finally, we have presented results relevant for the inner crust of
PNS, particularly at the crystallization temperature.
% icrust shells
% icrust mcp
