...
\end{figure}
%
The left panels in Fig.~\ref{fig:pj_icrust} shows the the normalized
...
distributation varies from $\approx 20$ up to $\approx 50$.
...
\end{figure}
%
In the inner crust, we have to address the problem of model dependence to make 
a quantitive prediction of the impurity parameter.
...
= 0.04$ fm$^{-3}$. 
The same trend is observed at $T= 1\times 10^{10}$ K (dashed 
lines), although the hierarchy of the models is not preserved.
