...
\end{equation}
%
\edit{where $M_i$ represents the ion mass in the e-cluster representation,
...
neglected. 
%
\edit{The only significant effect of the latter correction is to change
...
%
For the \edit{excess free energy of the Coulomb liquid}, we employ the 
...
The condition of crystallization of a OCP with \edit{associated composition 
...
n_g f_{HM}(n_g,1,T)$. \edit{It is important to stress that the Fermi energy 
...
\edit{The calculations are performed independently of those 
  of Fantina \textit{et al.}~\cite{Fantina2020}, thus observing a perfect 
