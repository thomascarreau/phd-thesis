...
% finite temperature -> distribution of nuclei
% assumptions

% review OCP approximation
% MCP
% present nuclear modeling required in the free neutron regime
...
\subsubsection{Energetics of clusters at finite temperature}
