...
could alter the relativistic electron gas. {The importance of these 
effects depends partly on the spin of odd nuclei.}

As in the zero-temperature limit, results in the {inner-crust regime} at 
...
years {(see for example~\cite{Oertel2017,Burgio2018})}, but in those 
studies simplified nuclear functionals were adopted, {baryon density} was 
...
\end{equation}
%
where $R'$ is the {radial coordinate at the bottom of the outer crust}, 
...
than the uncertainty due to our imperfect knowledge of the {CLD} part of 
...
until {$T\approx 1$~{MeV} $\approx 1.2\times 10^{10}$~K}, when the TETFSI 
