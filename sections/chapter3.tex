...
energy states $\rho(e)$. For a spinless free particle of energy $e=\hbar
...
\begin{figure}[!t]
  ...
  plasma in the outer crust]{Crystallization temperature $T_m$ as a function of
    pressure $P$ for the OCP in the outer crust. Experimental data from the 
    AME2016~\cite{Huang2017} are used when available. Mass excesses of
    $^{77-79}$Co are taken from~\cite{Welker2017}. The left panel shows $T_m$ 
...
the OCP approximation, Eq.~(\ref{eq:tmocp}). The experimental masses from the 
AME2016~\cite{Huang2017} are used when available, apart from the mass excesses
of $^{77-79}$Co which are better constrained in~\cite{Welker2017}. 
Experimental data are supplemented with the microscopic HFB-24 theoretical mass 
table~\cite{Goriely2013}.
...
including the small thermal corrections in the calcuation.

\subsection{Equilibrium composition}\label{subsec:compo_ocrust_tm}

% the crystallization temp of the outer crust is very low from the nuclear
% physics pov, thus one can legitimately wonder whether the crystallized
% composition is equivalent to that of CCM 
