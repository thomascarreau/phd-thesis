...
\end{equation}
%
The derivation of Eq.~(\ref{eq:eel}) is given in Appendix
\ref{appendix:epse}.\\
...
data from the AME2016~\cite{Huang2017}. \edit{Let us notice that the maximum density 
  at which experimentally studied nucleus $^{80}$Zn was present was found to be 
  slightly lower in
\cite{Haensel1994}, $\rho_B = 5.44 \times 10^{10}$ g/cm$^3$.} From
