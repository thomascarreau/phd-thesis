...
technique for the SLy4~\cite{Chabanat1998} functional with a Taylor expansion order $N=4$. 
In the top panel, the energy per nucleon is calculated 
...
contributions entering in the WS cell energy. In particular, we will see in
Chapter 3 that, at finite temperature, several corrections should be considered
it one wants to precisely estimate the crystallization temperature of the 
crust.} The Jacobian matrix 
