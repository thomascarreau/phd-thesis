...
\edit{
  ...
  %
  \begin{equation}
    M^\star c^2 = (A - Z)m_n c^2 + Zm_p c^2 + E_{cl} 
  ...
  %
  \begin{eqnarray}
    E_{WS} &=& M^\star c^2 + V_{WS}\varepsilon_e + V_{WS}(\varepsilon_g + n_g
    m_n c^2) \notag\\
...
energy. \edit{In the right panel, the constant value $9.429$
...
the \edit{two different} CLD calculations \edit{of the literature based on
